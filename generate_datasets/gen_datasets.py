import sys
sys.path.append("/home/sky/workspace/python/ChatGLM_ChatRobot")
import os
import datetime
import csv
...
from config.config import base_api_key, base_model, base_url
os.environ["OPENAI_API_KEY"] = base_api_key
...
def gen_data(raw_content):
    """
    使用LangChain GPT-3.5-turbo调用处理单个数据样例

    :param raw_content: 原始数据样例
    :return: GPT-3.5-turbo模型生成的内容。
    """
    # 系统消息定义背景和任务
